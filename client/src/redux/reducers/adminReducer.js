...
const adminReducer = (state = initialState, action) => {
  switch (action.type) {
    ...
    case UPDATE_ADMIN:
      return { ...state, updatedAdmin: action.payload, };

    case ADD_ADMIN:
      return { ...state, adminAdded: action.payload, };

    case CREATE_NOTICE:
      return { ...state, noticeCreated: action.payload, };

    case DELETE_ADMIN:
      return { ...state, adminDeleted: action.payload, };

    case DELETE_DEPARTMENT:
      return { ...state, departmentDeleted: action.payload, };

    case DELETE_FACULTY:
      return { ...state, facultyDeleted: action.payload, };

    case DELETE_STUDENT:
      return { ...state, studentDeleted: action.payload, };

    case DELETE_SUBJECT:
      return { ...state, subjectDeleted: action.payload, };

    case ADD_DEPARTMENT:
      return { ...state, departmentAdded: action.payload, };

    case ADD_FACULTY:
      return { ...state, facultyAdded: action.payload, };
    ...
    case ADD_SUBJECT:
      return { ...state, subjectAdded: action.payload, };
    ...
    case ADD_STUDENT:
      return { ...state, studentAdded: action.payload, };
